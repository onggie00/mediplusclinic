...
class Cek_pembayaran_dokter extends REST_Controller {
  ...
  public function get_hari($h){
    ...
    public function index_get()
    {
      ...
      $msg="";
      if ($token!='') {
        $dokter = $this->mymodel->getbywhere('dokter','token',$token,'row');
        ...
        if (!empty($dokter)) {
          ...
          $data = array(
          "status_pembayaran" => "Dibayar oleh Klinik / Rumah Sakit",
          "biaya_pembayaran" => "Rp. ".number_format($dokter->biaya_pembayaran,0,"","."),
