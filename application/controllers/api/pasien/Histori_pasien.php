  ...
  public function get_hari($h){
    ...
    public function index_get()
    {
      ...
      if ($token!='') {
        ...
        $data = $this->mymodel->withquery("select * from histori_data_scan where pasien_id='".$pasien->pasien_id."' and is_deleted='0' order by created_at DESC, klinik_id ASC",'result');
