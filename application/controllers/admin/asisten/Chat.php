...
class Chat extends CI_Controller {
  ...
  {
    redirect('admin/asisten/chat/data');
  }
	...
	public function data($val = "")
  {
    $this->is_login();
		...
		$pas = $this->mymodel->getbywhere('asisten_dokter','username',$this->session->userdata('asisten'),"row");
		$data['mydata'] = $this->mymodel->getbywhere('dokter','dokter_id',$pas->dokter_id,"row");
	...
	{
		$pas = $this->mymodel->getbywhere('asisten_dokter','username',$this->session->userdata('asisten'),"row");
		$mydata  = $this->mymodel->getbywhere('dokter','dokter_id',$pas->dokter_id,"row");
			$data = array(
			 'chatroom_id' => 0,
	...
	public function chat_list_side()
	{
		...
		$data["chat_room"] = $list;
		$this->load->view('admin/ajax/asisten_chat_list_side',$data);
	}
