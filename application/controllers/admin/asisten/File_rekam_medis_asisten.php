...
class File_rekam_medis_asisten extends CI_Controller {
  ...
  public function index($val = "")
  {
    ...
    $this->load->view('admin/data_file_rekam_medis_asisten');
  ...
  public function getdataedit()
  {
    ...
    $this->load->view('admin/modal_edit/file_rekam_medis_asisten',$data);
  }
