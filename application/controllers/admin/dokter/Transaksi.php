...
class Transaksi extends CI_Controller {
  ...
  public function index($val = "")
  {
    ...
    $this->load->view('admin/data_htransaksi_dokter');
  ...
  public function alldata()
  {
    ...
    $fetch_data = $this->Transaksi_datatable->make_datatables();
           ...
           {
            if ($value->dokter_id == $get_dokter->dokter_id && $value->is_deleted == "0") {
  ...
  public function insertdata()
  {
     ...
     if(!empty($data)){
      ...
      redirect('admin/dokter/transaksi/');
  }
  ...
  public function getdataedit()
  {
    ...
    $this->load->view('admin/modal_edit/transaksi',$data);
  }
