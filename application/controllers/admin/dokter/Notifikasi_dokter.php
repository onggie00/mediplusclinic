...
class Notifikasi_dokter extends CI_Controller {
  ...
  public function index($val = "")
  {
    ...
    $this->load->view('admin/data_notifikasi_pasien_dokter');
  ...
  public function alldata()
  {
    ...
    $fetch_data = $this->Notifikasi_asisten_datatable->make_datatables();
           ...
           foreach($fetch_data as $value)
           {
            ...
            if ($value->dokter_id == $get_dokter_data->dokter_id) {
  ...
  {
  	$get_dokter_data = $this->mymodel->getbywhere('dokter','username',$this->session->userdata('dokter'),'row');
    $get_pasien_member = $this->mymodel->getbywhere('expired_payment','dokter_id',$get_dokter_data->dokter_id,'result');
      ...
      redirect('admin/dokter/notifikasi_dokter/');
  }
  ...
  public function getdataedit()
  {
    ...
    $this->load->view('admin/modal_edit/notifikasi_pasien_dokter',$data);
  }
