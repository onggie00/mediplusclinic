...
class Broadcast_pasien extends CI_Controller {
    ...
    public function index($val = "")
  {
    ...
    $data['title_page'] = "Broadcast ke pasien";
    ...
    $this->load->view('admin/data_broadcast_pasien');
  ...
  public function alldata()
  {
    ...
    public function send_email()
    {
      ...
      // Konten/isi
       ...
       $data_['to'] = $_REQUEST['nama_lengkap'];
    ...
    public function getdataedit()
    {
      ...
      $this->load->view('admin/modal_edit/broadcast_pasien',$data);
    }
