...
class Histori_pasien extends REST_Controller {
  ...
  public function get_hari($h){
    ...
    public function index_get()
    {
      ...
      if ($token!='') {
        ...
        $data = $this->mymodel->withquery("select * from histori_data_scan where pasien_id='".$pasien->pasien_id."' and is_deleted='0' and created_at < '".$tanggal."' order by created_at DESC, klinik_id ASC",'result');
