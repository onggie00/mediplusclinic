          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php  $this->load->view('admin/modal_add/transaksi_klinik') ?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="deletedata" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <?php  $this->load->view('admin/modal_delete/transaksi_klinik') ?>
              </div>
            </div>
          </div>
        </div>
  ...
  $(document).ready(function(){
       ...
       var dataTable = $('#data').DataTable({
         ...
         "buttons": {
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/owner/biaya_klinik/alldata/'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
