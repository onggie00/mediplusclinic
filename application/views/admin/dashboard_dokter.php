                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600"><?php echo $dokter->nama_dokter; ?></h6>
                                                                <p><?php echo $poli->nama_poli; ?></p>
                                                                <h6><?php echo $rumah_sakit->nama_klinik; ?></h6>
                                                                
                                                                    <button id="<?php echo $dokter->dokter_id; ?>" class="btn btn-success waves-effect editfoto" type="button">
                                                                ...
                                                                <br/><br/>
                                                                    ...
                                                                    <button id="<?php echo $dokter->dokter_id; ?>" class="btn btn-success waves-effect editpw" type="button">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Nama Dokter</p>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"> <?php echo $dokter->email; ?> </h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Alamat Rumah</p>
                                                                        <h6 class="text-muted f-w-400"> <?php echo $dokter->alamat; ?> </h6>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Status Hadir</p>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Status Akun</p>
                                                                        <h6 class="text-muted f-w-400"> <?php 
                                            ...
                                            <div class="col-xl-3 col-md-12">
                                                <div class="card user-card2">
                                                    <div class="card-block text-center" style="min-height:420px;">
                                                        <h6 class="mb-2">Antrian</h6>
                                            ...
                                            <div class="col-xl-3 col-md-12">
                                                <div class="card user-card2">
                                                    ...
                                                    <form action="<?php echo site_url('admin/dokter/dashboard/next_antrian'); ?>" method="post">
    ...
    $(document).ready(function(){
       ...
       var dataTable = $('#data').DataTable({
         "dom": 'rtip',
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/dokter/dashboard/alldata/'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
...
<script >
    $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/dokter/dashboard/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
                $('#editform').html(data);
                $('#btneditdata').click();
    ...
    $(document).on('click', '.editfoto', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/dokter/profile/getfotoedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
                $('#fotoform').html(data);
                $('#btnfotodata').click();
    ...
    $(document).on('click', '.editpw', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/dokter/profile/getpwedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
                $('#pwform').html(data);
                $('#btnpwdata').click();
