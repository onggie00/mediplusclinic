          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php  $this->load->view('admin/modal_add/transaksi') ?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="deletedata" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <?php  $this->load->view('admin/modal_delete/transaksi') ?>
              </div>
            </div>
          </div>
        </div>
  ...
  $(document).ready(function(){
       ...
       var dataTable = $('#data').DataTable({
         ...
         "buttons": {
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/dokter/transaksi/alldata/'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
       ...
       $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/dokter/transaksi/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
                $('#editform').html(data);
                $('#btneditdata').click();
