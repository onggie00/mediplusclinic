          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <?php  $this->load->view('admin/modal_delete/rekam_medis_asisten') ?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="deletedetaildata" tabindex="-1" role="dialog" aria-labelledby="deletedetaildata" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <?php  $this->load->view('admin/modal_delete/detail_rekam_medis_asisten') ?>
              </div>
            </div>
          </div>
        </div>
  ...
  $(document).ready(function(){
       ...
       var dataTable = $('#data').DataTable({
         ...
         "buttons": {
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/asisten/rekam_medis_asisten/alldata/'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
       ...
       $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/asisten/rekam_medis_asisten/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
                $('#editform').html(data);
                $('#btneditdata').click();
        ...
        $(document).on('click', '.detail', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/asisten/rekam_medis_asisten/getdetaildata') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
        ...
        $(document).on('click', '.update_detail', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/asisten/file_rekam_medis_asisten/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
