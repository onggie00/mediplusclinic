<form class="cmxform" method="post" action="<?php echo site_url('admin/owner/broadcast_klinik/send_email') ?>">
  <input type="hidden" name="data_id" value="<?php echo $data->klinik_id; ?>">
  <fieldset>
    <div class="form-group">
      <label for="nama">Nama RS / Klinik </label>
      <input class="form-control " type="text" name="nama_klinik" value="<?php echo $data->nama_klinik; ?>">
    </div>
