...
<table id="data3" class="table table-striped table-bordered table-responsive">
    ...
    $tanggal = $tgl." ".$bln." ".$thn;
      ...
      <br>
  <form enctype="multipart/form-data" class="cmxform" method="post" action="<?php echo site_url('admin/asisten/file_rekam_medis_asisten/insertdata') ?>">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input class="form-control " name="hdokter_id" type="text" disabled value="<?php echo $get_dokter->nama_dokter; ?>">
      <input class="form-control " name="dokter_id" type="hidden" value="<?php echo $get_dokter->dokter_id; ?>" >
    </div>
