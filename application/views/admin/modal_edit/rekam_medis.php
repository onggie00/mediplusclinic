<form class="cmxform" method="post" action="<?php echo site_url('admin/dokter/rekam_medis/updatedata') ?>">
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input class="form-control " type="hidden" name="dokter_id" value="<?php echo $this->mymodel->getbywhere('dokter','username',$this->session->userdata('dokter'),'row')->dokter_id; ?>">
      <input class="form-control " type="text" disabled name="nama_dokter" value="<?php echo $this->mymodel->getbywhere('dokter','username',$this->session->userdata('dokter'),'row')->nama_dokter; ?>">
    </div>
    <div class="form-group">
