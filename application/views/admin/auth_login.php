            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="<?php echo site_url('admin/auth_login/cek_login'); ?>" method="post">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                            ...
                                            <div class="col-md-6">
                                                <button type="submit" name="btn_dokter" class="btn btn-info btn-md btn-block waves-effect waves-light text-center m-b-20">Admin Dokter</button>
                                            </div>
                                            <div class="col-md-12">
                                                <button type="submit" name="btn_asisten" class="btn btn-secondary btn-md btn-block waves-effect waves-light text-center m-b-20">Admin Asisten Dokter</button>
                                            </div>
                                    </div>
                                    <hr>
                                    <div class="row">
