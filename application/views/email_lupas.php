                                ...
                                <tr>
                                  <td align="center" valign="top" class="textContent">
                                    <div class="brand-logo" style="display:inline-block;">
                                        <img src="<?php echo base_url('assets/image/admin/'); ?>logo_mediplus.png" width="30px" height="30px" alt="" style="float:left; margin-right:5px;">
                                        <span class="mypro" style="font-size: 24px;font-weight: 700;color: #fff; float:left; margin-right:5px;"> Mediplus </span>
                                        <span class="spec" style="font-size: 24px;font-weight: 300;color: #fff; float:left; margin-right:5px;"> App</span>
                                    </div>
