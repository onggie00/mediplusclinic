    ...
    public function index_post()
    {
      ...
      if(isset($headers['token']))
        ...
        if (empty($cektoken)) {
          ...
          $cekShare =  $this->mymodel->getbywhere('share',"date_share='$date' and relawan_id = $cektoken->relawan_id and news_id =$news_id",null,'row');
          if (!empty($cekShare)) {
          ...
          $data = array(
            ...
            $in = $this->mymodel->insert('share',$data);
            $data = array(
              'relawan_id' => $cektoken->relawan_id,
              'poin' => 10,
              'keterangan' => "Bagikan Berita",
              'created_at' => date('Y-m-d H:i:s')
            );
